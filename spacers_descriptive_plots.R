...
# read in spacer df
spacers <- read_csv("spacer_targets.csv") %>%
...
# write to file
write.csv(spacers_all, "spacers_all.csv")
...
ggsave(plot=descript_plots_overview, "desc_plots_spacers_type.pdf", width = 30, height = 15, units = "cm")
...
ggsave(plot=descript_plots, "desc_plots_spacers.pdf", dpi=300, width = 40, height = 20, units = "cm")
